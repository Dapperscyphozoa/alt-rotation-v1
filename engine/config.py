...
STRATEGY_PARAMS = {
    ...
    "candles_history":int(os.environ.get("CANDLES_HISTORY", "250")),
    "alt_slope_min":  float(os.environ.get("STRATEGY_ALT_SLOPE_MIN", "0.02")),
    "vol_mult":       float(os.environ.get("STRATEGY_VOL_MULT", "1.2")),
}
